 ...
 */
class getEmailSenderServiceService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Service\EmailSenderService' shared autowired service.
     *
     * @return \App\Service\EmailSenderService
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/src/Service/EmailSenderService.php';
        ...
        if (isset($container->privates['App\\Service\\EmailSenderService'])) {
            return $container->privates['App\\Service\\EmailSenderService'];
        }

        return $container->privates['App\\Service\\EmailSenderService'] = new \App\Service\EmailSenderService(new \Symfony\Component\Mailer\Mailer((new \Symfony\Component\Mailer\Transport(new RewindableGenerator(function () use ($container) {
