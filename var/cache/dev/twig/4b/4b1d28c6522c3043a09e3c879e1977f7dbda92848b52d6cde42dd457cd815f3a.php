...
class __TwigTemplate_0f9d5dbded2f7a4b9cd130b00dc251f5cd151a98b3ead12c88c5b8ea090121d0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "  <section class=\"gradient-form h-full dark:bg-neutral-700 mt-48 mb-8 flex justify-center\" style=\"background: linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593);\">
    <div class=\"container h-full p-10\">
      <div class=\"g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200\">
        <div class=\"w-full\">
          <div class=\"block rounded-lg bg-white shadow-lg dark:bg-neutral-800\">
            <div class=\"bg-black flex justify-center\">
              <div class=\"bg-black px-4 md:px-0 lg:w-6/12\">
                <div class=\"md:mx-6 md:p-12\">
                  <div class=\"text-center\">
                      ...
                      src=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/logo_transparent.png"), "html", null, true);
        echo "\"
                      alt=\"logo\" />
                  </div>
                  <form method=\"post\">
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 21, $this->source); })())) {
            // line 22
            echo "                      <div class=\"flex justify-center mb-4 rounded-lg bg-danger-100 py-5 px-6 text-base text-danger-700\" role=\"alert\">
                        Invalid credential !
                      </div>
                  ";
        }
        // line 26
        echo "                  <div class=\"relative mb-4\" data-te-input-wrapper-init>
                    <input
                          type=\"email\"
...
";
    ...
    {
        return array (  142 => 50,  116 => 26,  110 => 22,  108 => 21,  101 => 17,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}StageSeller | Login{% endblock %}

{% block body %}
  <section class=\"gradient-form h-full dark:bg-neutral-700 mt-48 mb-8 flex justify-center\" style=\"background: linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593);\">
    <div class=\"container h-full p-10\">
      <div class=\"g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200\">
        <div class=\"w-full\">
          <div class=\"block rounded-lg bg-white shadow-lg dark:bg-neutral-800\">
            <div class=\"bg-black flex justify-center\">
              <div class=\"bg-black px-4 md:px-0 lg:w-6/12\">
                <div class=\"md:mx-6 md:p-12\">
                  ...
                  <form method=\"post\">
                  {% if error %}
                      <div class=\"flex justify-center mb-4 rounded-lg bg-danger-100 py-5 px-6 text-base text-danger-700\" role=\"alert\">
                        Invalid credential !
                      </div>
                  {% endif %}
                  <div class=\"relative mb-4\" data-te-input-wrapper-init>
